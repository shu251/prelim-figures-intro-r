...
#### Make basic plots - first look at data
...
##### _Convert data frame to long format_
...
##### _Consider blank samples_
library(decontam)

##### _Add/include metadata_
...
##### _Sum data by diffrent attributes - barplot_
geom_bar

##### _Make my plot fancy_
